...
<button
  type="button"
  class="rounded-md p-2 text-muted hover:bg-surface-2 hover:text-ink transition-colors"
  aria-label={theme.value === 'dark' ? 'Passer en thème clair' : 'Passer en thème sombre'}
  title={theme.value === 'dark' ? 'Thème clair' : 'Thème sombre'}
